 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | SYMB | LGUI | LAlt | /Space  /       \Enter \  |BackSP|RAISE | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, MO(AJS), TG(WRK),    KC_N,     KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
                              MO(SYM), KC_LGUI, KC_LALT,  KC_SPC,  KC_ENT, KC_BSPC, MO(RAI), KC_RGUI \
),
/* SYMBOLS
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[SYM] = LAYOUT( \
  ...
  XXXXXXX, XXXXXXX, KC_MINS, KC_UNDS, KC_COLN, KC_PLUS,                   KC_TILD,  KC_EQL,  KC_DOT, KC_LCBR, KC_RCBR, KC_PIPE, \
  XXXXXXX, XXXXXXX,  KC_GRV,   KC_LT,   KC_GT, XXXXXXX, _______, _______, XXXXXXX, KC_BSLS, KC_SLSH, KC_LBRC, KC_RBRC, XXXXXXX, \
 ...
 */
  ...
  _______,    KC_A,    KC_S,    KC_H,    KC_I,    KC_G,                      KC_Y,    KC_N,    KC_E,    KC_O,    KC_I, _______, \
