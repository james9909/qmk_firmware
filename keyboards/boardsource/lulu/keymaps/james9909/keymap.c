 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |  FUN | LGUI | LAlt | /Space  /       \Enter \  |BackSP|  NAV | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [QWERTY] = LAYOUT(
   ...
   KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, RGB_TOG,  TG(WRK),   KC_N,     KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(SYM), \
                              MO(FUN), KC_LGUI, KC_LALT,  KC_SPC,   KC_ENT,KC_BSPC,  MO(NAV), KC_RGUI \
),
/* WORKMAN
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |   ⇩  |   ⇩  |   ⇩  |   ⇩  |   ⇩  |   ⇩  |                    |   ⇩  |   ⇩  |   ⇩  |   ⇩  |   ⇩  |   ⇩  |
 ...
 */
  ...
  _______, KC_LBRC, KC_RBRC, KC_UNDS, KC_COLN, KC_PLUS,                   KC_TILD,  KC_EQL, KC_LCBR, KC_RCBR, _______, _______, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_GRV, _______, _______, KC_BSLS, KC_SLSH, _______, _______, _______, _______, \
                             _______, _______, _______, _______, _______,  _______, _______, _______ \
),
/* Fn Keys and Arrows
 * ,-----------------------------------------.                    ,-----------------------------------------.
